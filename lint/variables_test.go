...
func TestVariableExpansion(t *testing.T) {
	for _, tc := range []struct {
		desc      string
		expr      string
		variables []dashboard.VariableModel
		result    string
		err       error
	}{
		{
			...
			variables: []dashboard.VariableModel{
				{
					...
					Options: []dashboard.VariableOption{
						{
							Value: dashboard.StringOrArrayOfString{String: toPtr("4h")},
						},
					},
				},
				{
					...
					Options: []dashboard.VariableOption{
						{
							Value: dashboard.StringOrArrayOfString{String: toPtr("5m")},
						},
					},
				},
				{
					...
					Options: []dashboard.VariableOption{
						{
							Value: dashboard.StringOrArrayOfString{String: toPtr("value")},
						},
					},
				},
			},
			...
			variables: []dashboard.VariableModel{
				{
					...
					Current: &dashboard.VariableOption{
						Value: dashboard.StringOrArrayOfString{String: toPtr("$__auto_interval_interval")},
					},
				},
			},
			...
			variables: []dashboard.VariableModel{
				{
					Name: "interval",
					Current: &dashboard.VariableOption{
						Value: dashboard.StringOrArrayOfString{String: toPtr("$__auto_interval")},
					},
				},
			},
			result: "sum (rate(cpu{}[10s]))",
			...
			variables: []dashboard.VariableModel{
				{
					Name: "interval",
					Current: &dashboard.VariableOption{
						Value: dashboard.StringOrArrayOfString{String: toPtr("$interval")},
					},
				},
			},
